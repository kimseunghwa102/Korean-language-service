  ...
  var levelfive = new Array('가격 値段', '감기 歌風', '감동 感動','가구　家具', '가방　カバン', '가을　秋', '가족　家族', '값　値段', '강　川', '거리　距離', '걱정　心配', '결혼식　結婚式', '경주　試合', '경험　経験', '계절　季節', '계획　計画', '고민　悩み',  '고양이　猫', '고향　故郷', '곳　所', '공연　公演', '공원　公園  ', '공책　ノート', '공항　航行', '과일　果物', '과자　お菓子', '관심　興味', '교통사고　交通事項', '구두　靴', '구입　購入', '그림　絵','극장劇所', '근처近所', '글자文字', '금년今年', '기간期間')
  var levelfive = new Array('기분気分','김치キムチ', '까만색黒い色', '꽃花', '꽃집花や', '나라国', '나무木', '날日', '날씨天気', '산山', '내년来年', '내용内容', '내일明日', '냉면冷麺', '냉장고冷蔵工', '년年', '노래歌', '누나お姉さん', '눈물涙', '느낌感じ', '다음次ぎ', '다음달来月','단어言葉', '달月（つき）',  '도서관図書館', '돈お金', '동생いとこ', '뒤裏', '드라마ドラマ', '등산当山', '등산화山登り靴', '라디오ラジオ', '러시아ロシア', '머리頭', '모습様子')
